...
public class PhotosReadServiceIntegrationTest {
    ...
    void getAllPhotosForUser_WillReturnPhotosOwnedByUser() {
        ...
        assertEquals(expectedPhotos, photosReadService.getAllPhotosForUser(USER_ID_1, Pageable.unpaged()));
    }

    @Test
    void getAllPhotosForUser_WillRetrievePagesWhenRequestedRespectingOrder() {
        var firstPage = photosReadService.getAllPhotosForUser(USER_ID_1, PageRequest.of(0, 1, DESC, "uploadTimestamp"));
        var secondPage = photosReadService.getAllPhotosForUser(USER_ID_1, PageRequest.of(1, 1, DESC, "uploadTimestamp"));
