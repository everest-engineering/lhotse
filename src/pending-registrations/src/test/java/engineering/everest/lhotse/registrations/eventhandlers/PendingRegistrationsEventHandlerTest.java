...
class PendingRegistrationsEventHandlerTest {
    ...
    void onOrganizationRegistrationConfirmedAfterUserWithEmailCreated_WillDeleteProjectedPendingRegistration() {
        var organizationRegistrationConfirmedAfterUserWithEmailCreatedEvent = new OrganizationRegistrationConfirmedAfterUserWithEmailCreatedEvent(ORGANIZATION_ID, REGISTERING_USER_ID, CONTACT_EMAIL);
