...
class ApplicationFunctionalTests {
    ...
    void newUsersCanRegisterTheirOrganizationAndCreateNewUsersInTheirOrganization() {
        ...
        var pendingRegistration = pendingRegistrationsRepository.findById(newOrganizationId); // Confirmation code is "emailed", but we can cheat and pull it from the DB.
